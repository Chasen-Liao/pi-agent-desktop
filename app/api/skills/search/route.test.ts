...
test("getAllowedSkillsApiBase allows localhost only outside production", () => {
  assert.equal(getAllowedSkillsApiBase("http://localhost:4000", "development"), "http://localhost:4000");
  assert.equal(getAllowedSkillsApiBase("http://127.0.0.1:4000", "test"), "http://127.0.0.1:4000");
